...
export const ActivityIcon = ({ className, strokeWidth = "2" }: { className?: string, strokeWidth?: string | number }) => (
...
export const BloodTestIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="currentColor">
    <path d="M21 19H3v2h18v-2zM12 2C8.42 2 6 5.33 6 9.5c0 3.32 2.42 6.55 6 9.5 3.58-2.95 6-6.18 6-9.5C18 5.33 15.58 2 12 2z"/>
  </svg>
);
...
export const FileDownloadIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="currentColor">
